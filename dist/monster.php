...
$monsters[] = new Monster("フランケンゾンビ", "img/monster_01.png", 100, 30, 40);
$monsters[] = new MagicMonster("エルダーリッチ", "img/monster_02.png", 100, 2, 30, 50);
$monsters[] = new Monster("ホワイトゴースト", "img/monster_03.png", 100, 10, 40);
$monsters[] = new Monster("ヴァンパイア男爵", "img/monster_04.png", 100, 10, 40);
$monsters[] = new Monster("大きなクモ", "img/monster_05.png", 100, 30, 40);
$monsters[] = new Monster("ミイラおとこ", "img/monster_06.png", 100, 20, 40);
...
function gameOver()
{
    ...
    debug("セッションの中身を確認しています。 ajax.php" . print_r($_SESSION, true));
    debug("  ");
}
