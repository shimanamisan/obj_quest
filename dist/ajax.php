        ...
        switch (true) {
            ...
            case $_POST['data'] === "js-attack":
                ...
                // モンスターを倒したら別のモンスターを呼び出す
                    ...
                    if ($_SESSION['monster']->getHp() <= 0) {
                        History::set($_SESSION['monster']->getName() . "を倒した！！ <button class='p-history__btn'>▼</button>");
                    }
                }
            
                debug("モンスターのセッションの値を取得しています ajax.php ". get_class($_SESSION['monster']));
                debug("  ");
            ...
            case $_POST['data'] === "js-gard":
                ...
                // モンスターを倒したら別のモンスターを呼び出す
                    ...
                    if ($_SESSION['monster']->getHp() <= 0) {
                        History::set($_SESSION['monster']->getName() . "を倒した！！ <button class='p-history__btn' id='js-next-monster'>▼</button>");
                    }
                }
            ...
            case $_POST['data'] === "top-page-back":
                ...
                debug("セッションをクリアしました。トップページ画面へ戻ります。 : " . print_r($_SESSION, true));
                debug("  ");
            break;
